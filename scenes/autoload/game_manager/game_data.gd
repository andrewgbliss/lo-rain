...
var prev_door_id = ""
var current_door_id = ""
var movement_direction: CharacterController.MovementDirection = CharacterController.MovementDirection.Down
...
func restore(data):
	...
	if data.has("movement_direction"):
...
func reset():
	...
	prev_door_id = ""
	current_door_id = ""
	movement_direction = CharacterController.MovementDirection.Down
	current_scene_path = ""
	from_scene_path = ""
