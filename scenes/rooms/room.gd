...
@export var top_bar_active: bool = true

@export_category("Text Parser Descriptions")
@export var descriptions: Dictionary[String, Array]
...
func _has_loaded():
	camera.enabled = true
	camera.make_current()
	MenuTopBar.active = top_bar_active
